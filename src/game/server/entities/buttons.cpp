...
SpawnAction CMultiSource::Spawn()
{
...
SpawnAction CMomentaryRotButton::Spawn()
{
    CBaseToggle::AxisDir( this );
...
SpawnAction CButtonTarget::Spawn()
{
    pev->movetype = MOVETYPE_PUSH;
    pev->solid = SOLID_BSP;
    SetModel( STRING( pev->model ) );
