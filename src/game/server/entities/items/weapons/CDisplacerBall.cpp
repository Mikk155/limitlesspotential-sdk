...
void CDisplacerBall::FizzleThink()
{
    ...
    pev->dmg = g_cfg.GetValue( "plr_displacer_other"sv, 250, this );
...
void CDisplacerBall::ExplodeThink()
{
    ...
    RadiusDamage( pev->origin, this, pOwner, pev->dmg, g_cfg.GetValue( "plr_displacer_radius"sv, 300, this ), DMG_ALWAYSGIB | DMG_BLAST );
