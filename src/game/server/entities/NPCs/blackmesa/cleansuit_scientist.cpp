...
void CCleansuitScientist::OnCreate()
{
    ...
    pev->health = g_Skill.GetValue( "cleansuit_scientist_health"sv, 20, this );
...
void CCleansuitScientist::Heal()
{
    ...
    m_hTargetEnt->GiveHealth( g_Skill.GetValue( "cleansuit_scientist_heal"sv, 25, this ), DMG_GENERIC );
...
void CDeadCleansuitScientist::OnCreate()
{
    ...
    pev->health = 8; // g_Skill.GetValue( "scientist_health"sv, 20, this );
    pev->model = MAKE_STRING( "models/cleansuit_scientist.mdl" );
