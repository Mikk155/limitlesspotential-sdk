    ...
    if( m_hEnemy )
    {
        ...
        else
        {
            ...
            if( firstShotInBurst )
            {
                ...
                FireBullets( g_cfg.GetValue<float>( "hgrunt_ally_pellets"sv, 3, this ), vecShootOrigin, vecShootDir, VECTOR_CONE_15DEGREES, 2048, BULLET_PLAYER_BUCKSHOT, 0 ); // shoot +-7.5 degrees
...
SpawnAction CDeadHGruntAlly::Spawn()
{
