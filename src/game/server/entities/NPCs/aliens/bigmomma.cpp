...
void CBMortar::Touch( CBaseEntity* pOther )
{
    ...
    RadiusDamage( pev->origin, this, owner, g_cfg.GetValue<float>( "bigmomma_dmg_blast"sv, 160, this ), g_cfg.GetValue<float>( "bigmomma_radius_blast"sv, 275, this ), DMG_ACID );
    UTIL_Remove( this );
}
