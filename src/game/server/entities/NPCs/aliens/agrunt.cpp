...
void CAGrunt::HandleAnimEvent( MonsterEvent_t* pEvent )
{
    ...
    {
        CBaseEntity* pHurt = CheckTraceHullAttack( AGRUNT_MELEE_DIST, g_cfg.GetValue( "agrunt_dmg_punch"sv, 20, this ), DMG_CLUB );
...
bool CAGrunt::Spawn()
{
    ...
    pev->health = g_cfg.GetValue( "agrunt_health"sv, 120, this );
