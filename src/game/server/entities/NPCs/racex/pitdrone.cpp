...
void CPitdroneSpike::SpikeTouch( CBaseEntity* pOther )
{
    ...
    {
        pOther->TakeDamage( this, this, g_Skill.GetValue( "pitdrone_dmg_spit"sv, 15, this ), DMG_GENERIC );
...
void CPitdrone::OnCreate()
{
    ...
    pev->health = g_Skill.GetValue( "pitdrone_health"sv, 110, this );
...
void CPitdrone::HandleAnimEvent( MonsterEvent_t* pEvent )
{
    ...
    {
        // SOUND HERE!
        CBaseEntity* pHurt = CheckTraceHullAttack( 70, g_Skill.GetValue( "pitdrone_dmg_bite"sv, 25, this ), DMG_SLASH );
    ...
    {
        CBaseEntity* pHurt = CheckTraceHullAttack( 70, g_Skill.GetValue( "pitdrone_dmg_whip"sv, 35, this ), DMG_CLUB | DMG_ALWAYSGIB );
        if( pHurt )
        {
