...
void COFChargedBolt::ChargedBoltTouch( CBaseEntity* pOther )
{
    ...
    {
        ClearMultiDamage();
        pOther->TakeDamage( this, this, g_Skill.GetValue( "voltigore_dmg_beam"sv, 60, this ), DMG_ALWAYSGIB | DMG_SHOCK );
    }
    ...
    RadiusDamage( pev->origin, this, pevOwner, g_Skill.GetValue( "voltigore_dmg_beam"sv, 60, this ), 128.0, DMG_ALWAYSGIB | DMG_SHOCK );
...
void COFVoltigore::OnCreate()
{
    ...
    pev->health = g_Skill.GetValue( "voltigore_health"sv, 450, this );
...
void COFVoltigore::HandleAnimEvent( MonsterEvent_t* pEvent )
{
    ...
    {
        CBaseEntity* pHurt = CheckTraceHullAttack( GetMeleeDistance(), g_Skill.GetValue( "voltigore_dmg_punch"sv, 50, this ), DMG_CLUB );
...
void COFVoltigore::DeathGibThink()
{
    ...
    else
    {
        ...
        ::RadiusDamage( pev->origin, this, this, g_Skill.GetValue( "voltigore_dmg_beam"sv, 60, this ), 160.0, DMG_ALWAYSGIB | DMG_SHOCK );
    }
}
