...
public:
    ...
    virtual float GetDamageAmount() { return g_cfg.GetValue( "shockroach_dmg_bite"sv, 10, this ); }
...
void COFShockRoach::OnCreate()
{
    ...
    pev->health = g_cfg.GetValue( "shockroach_health"sv, 20, this );
...
void COFShockRoach::MonsterThink()
{
    ...
    if( lifeTime >= g_cfg.GetValue( "shockroach_lifespan"sv, 10, this ) )
