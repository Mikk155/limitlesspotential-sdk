...
public:
    ...
    virtual float GetDamageAmount() { return g_cfg.GetValue<float>( "shockroach_dmg_bite"sv, 10, this ); }
...
void COFShockRoach::MonsterThink()
{
    ...
    if( lifeTime >= g_cfg.GetValue<float>( "shockroach_lifespan"sv, 10, this ) )
